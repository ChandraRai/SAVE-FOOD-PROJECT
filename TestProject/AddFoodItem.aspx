  ...
  <div class="container editForm">
    ...
    <div class="form-group" runat="server">
      <div class="input-group mb-3">
        <asp:TextBox id="txtUserName" type="text" class="form-control" placeholder="Username" aria-label="Username"
      ...
      <asp:RequiredFieldValidator ID="rfvFoodName" runat="server" ErrorMessage="Food Name is Required"
        ControlToValidate="txtFoodName" Display="Dynamic"></asp:RequiredFieldValidator>
      <div class="input-group mb-3">
      ...
      <asp:RequiredFieldValidator ID="rfvExpiry" runat="server" ErrorMessage="Expiry Date is Required"
        ControlToValidate="txtExpiry" Display="Dynamic"></asp:RequiredFieldValidator>
      <div class="input-group mb-3">
        <asp:TextBox id="txtAddress" type="text" class="form-control" placeholder="Address*" aria-label="Address"
          aria-describedby="basic-addon1" runat="server" />
      </div>
      ...
      <div class="input-group mb-3">
        <asp:TextBox id="txtCity" type="text" class="form-control" placeholder="City*" aria-label="City"
          aria-describedby="basic-addon1" runat="server" />
      </div>
      ...
      <div class="input-group mb-3">
        <asp:TextBox id="txtPostal" type="text" class="form-control" placeholder="Postal Code*" aria-label="Postal Code"
          aria-describedby="basic-addon1" runat="server" />
      </div>
      <asp:RequiredFieldValidator ID="rfvPostal" runat="server" ErrorMessage="Postal Code is Required"
        ControlToValidate="txtPostal" Display="Dynamic"></asp:RequiredFieldValidator>
      <div class="input-group mb-3">
      ...
      <asp:RequiredFieldValidator ID="rfvDesc" runat="server" ErrorMessage="Food Description is Required"
        ControlToValidate="txtFoodDesc" Display="Dynamic"></asp:RequiredFieldValidator>
      <br />
