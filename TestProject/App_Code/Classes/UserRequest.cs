...
public class UserRequest
{
    ...
    public UserRequest(string username,string _itemType,string _itemDetails)
    {
    ...
    public UserRequest(string _URId,string _itemType,string _itemDetails,string _date,string UId, int _status)
    {
        URId = _URId;
        ItemType = _itemType;
        ItemDetails = _itemDetails;
