		...
		<div class="login-container p-l-10 p-r-10 p-t-30 p-b-260">
			<form class="validate-form" runat="server" id="signUpForm">
                ...
                <div class="login validate-input m-b-10" data-validate="Enter First Name">
                    <asp:TextBox runat="server" ID="txtFirstName" CssClass="input-username shadow" placeholder="Enter First Name" ></asp:TextBox>
                ...
                <div class="login validate-input m-b-10" data-validate="Enter Last Name">
                    <asp:TextBox runat="server" ID="txtLastName" CssClass="input-username shadow" placeholder="Enter Last Name" ></asp:TextBox>
				...
				<div class="login validate-input m-b-10" data-validate="Enter Username">
                    <asp:TextBox runat="server" ID="txtUserName" CssClass="input-username shadow" placeholder="Enter Username" ></asp:TextBox>
                ...
                <div class="login validate-input m-b-10" data-validate="Enter Email">
                    <asp:TextBox runat="server" CssClass="input-username shadow" placeholder="Enter Email" ID="txtEmail"></asp:TextBox>
                ...
                <div class="login validate-input m-b-10" data-validate="Enter phone Number">
                    <asp:TextBox runat="server" CssClass="input-username shadow" placeholder="Phone Number" ID="txtPhone" MaxLength="10"></asp:TextBox>
                    ...
                    ErrorMessage="Invali Phone Number"
                ...
                <div class="login validate-input m-b-10" data-validate="Enter password">
                    <asp:TextBox runat="server" CssClass="input-username shadow" placeholder="Password" ID="txtPassword" TextMode="Password"></asp:TextBox>
                ...
                <div class="login validate-input m-b-35" data-validate = "repeat password">
                    <asp:TextBox runat="server" CssClass="input-username shadow" placeholder="Confirm Password" ID="txtPasswordConfirm" TextMode="Password"></asp:TextBox>
				...
				<div class="container-login100-form-btn">
					<asp:Button class="login100-form-btn shadow" runat="server" ID="btnSignUp" Text="Sign Up" OnClick="btnSignUp_Click">
					</asp:Button>
				</div>
			</form>
		</div>
